...
ui = fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("About",
             ...
             p("If you want to cite the dashboard directly, please use: Essfors, H (2026). The Finnish Linguistic Diversity Dashboard [Shiny web application], https://f39e09-hannes-essfors.shinyapps.io/ling_fin/."),
